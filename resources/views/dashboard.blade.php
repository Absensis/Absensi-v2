            ...
            <dl class="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
                <div class="flex">
                    <div class="bg-white rounded shadow" style="width: 100%; padding: 20px;">
                        <div class="bg-white rounded-full shadow" style="width: 60px; height: 60px; margin-left: 40%;">
                            <i class="fas fa-address-book fa-2x" style="margin-top: 15px; margin-left: 17px; color: blue;"></i>
                        </div>
                ...
                <div class="flex">
                    <div class="bg-white rounded shadow" style="width: 100%; padding: 20px;">
                        <div class="bg-white rounded-full shadow" style="width: 60px; height: 60px; margin-left: 40%;">
                            <i class="fas fa-user-tie fa-2x" style="margin-top: 15px; margin-left: 17px; color: green;"></i>
                        </div>
                ...
                <div class="flex">
                    <div class="bg-white rounded shadow" style="width: 100%; padding: 20px;">
                        <div class="bg-white rounded-full shadow" style="width: 60px; height: 60px; margin-left: 40%;">
                            <i class="fas fa-book fa-2x" style="margin-top: 15px; margin-left: 17px; color: magenta;"></i>
                        </div>
